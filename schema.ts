...
export interface components {
  schemas: {
    ...
    /**
     * @description This is new. FOO dd.Preservation status of the resource 
     * @enum {string|null}
     */
    Status: "Not Started" | "In Progress" | "Done" | null;
    /**
     * @description Changed..The access level of the resource 
     * @enum {string|null}
     */
    ...
    Work: {
      ...
      /** @description Location of Physical Object it will also include messy dates. Information about the provenance, such as origin, ownership and custodial history (chain of custody), of a resource. */
      provenance: (string)[];
