...
export interface components {
  schemas: {
    ...
    Work: {
      ...
      /** @description Location of Physical ssObject // will also include messy dates. Information about the provenance, such as origin, ownership and custodial history (chain of custody), of a resource. */
      provenance: (string)[];
